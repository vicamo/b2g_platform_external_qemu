...
#  define  AASSERT_INT_LT(cond,val)      AASSERT_INT(cond,val)
#  define  AASSERT_INT_LTE(cond,val)     AASSERT_INT(cond,val)
#  define  AASSERT_INT_GT(cond,val)      AASSERT_INT(cond,val)
#  define  AASSERT_INT_GTE(cond,val)     AASSERT_INT(cond,val)
#  define  AASSERT_INT_EQ(cond,val)      AASSERT_INT(cond,val)
#  define  AASSERT_INT_NEQ(cond,val)     AASSERT_INT(cond,val)
